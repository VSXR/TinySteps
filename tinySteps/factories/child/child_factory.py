...
class ChildUrl_Factory:
    ...
    def create_urls():
        ...
        from tinySteps.views.child import core_views, form_views, feature_views
        ...
        return [
            ...
            path('children/<int:child_id>/vaccine-card/', feature_views.child_vaccine_card, name='child_vaccine_card'),
        ]