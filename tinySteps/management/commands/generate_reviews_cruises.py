...
from relecloud.models import Cruise, CruiseReview

class Command(BaseCommand):
    help = 'Generate random reviews for cruises'
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS('Successfully generated reviews for all cruises'))