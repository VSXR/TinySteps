...
from ..repositories import Guide_Repository
from ..models import Guides_Model, Notification_Model

class AdminGuide_Service:
    """Service for guide administration tasks implementing SRP and DIP"""
...
class Notification_Repository:
    """Repository for notifications - supports DIP"""
