...
from ..services.admin_service import AdminGuide_Service
from ..forms import GuideRejection_Form
...
def approve_guide(request, guide_id):
    """Admin view to approve a guide following DIP and SRP"""
...
def reject_guide(request, guide_id):
    """Admin view to reject a guide following DIP and SRP"""
    admin_service = AdminGuide_Service()
...
def admin_dashboard(request):
    """Admin dashboard view following DIP and SRP"""
    admin_service = AdminGuide_Service()
