...
from ..forms import CustomUserCreation_Form, PasswordReset_Form
from ..models import PasswordReset_Model, YourChild_Model, ParentsForum_Model

class Login_View(auth_views.LoginView):
    """Login view implementing SRP"""
...
class Logout_View(auth_views.LogoutView):
    """Logout view implementing SRP"""
    next_page = 'index'
    
    def dispatch(self, request, *args, **kwargs):
        """Override dispatch to add logout message"""
        messages.success(request, _("You have been logged out successfully."))
        return super().dispatch(request, *args, **kwargs)

class Register_View(SuccessMessageMixin, CreateView):
    """User registration view implementing SRP"""
    ...
    def form_valid(self, form):
        """Handle valid form submission - log the user in"""
...
def password_reset(request):
    """Password reset view implementing SRP"""
